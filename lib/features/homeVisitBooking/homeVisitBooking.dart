...
import '../../../views/Doctor/InAppWebiewSubscribtionScreen.dart';


class homeVisitBooking extends StatefulWidget {
  String id;
  String name;
  String consultationFee;

  homeVisitBooking(this.id, this.name, this.consultationFee);

  @override
  _MakeAppointmentState createState() => _MakeAppointmentState();
}

class _MakeAppointmentState extends State<homeVisitBooking> {
