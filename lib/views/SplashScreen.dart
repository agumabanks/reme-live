      ...
      body: Stack(
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Image.asset(width: Get.width /2 -50,
          ...
          Positioned(
            bottom: 30,right: MediaQuery.of(context).size.width /2 - 40, 
            child: Text("Remedius Live",style: GoogleFonts.poppins(
...
//           Positioned(
//             bottom: 15, left: Get.width / 2 - 60 ,
//             child: Text('Remedius Live 1.1',  style: GoogleFonts.roboto(
//                                     fontWeight: FontWeight.w400,
//                                     color: white,
//                                     fontSize: 13),))
//         ],
